  ...
  <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-12 max-w-md mx-auto shadow-2xl">
    ...
    <div className="w-full space-y-3 mb-8">
      ...
      <div className="flex justify-center gap-4 py-4">
        <button aria-label="Googleでログイン" onClick={onLogin} className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center hover:bg-gray-50">
        ...
        <button aria-label="メールで登録" onClick={onEmailSignup} className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center hover:bg-gray-50">
