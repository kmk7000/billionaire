            ...
            {section.title === '紹介' && userProfile?.introduction ? (
              ...
              <div className="space-y-3">
                ...
                {userProfile?.careers && userProfile.careers.map((careerItem) => (
                  <div key={careerItem.id} className="bg-gray-50 rounded-lg p-4 relative group">
                    <h4 className="font-bold text-gray-900">{careerItem.companyName}</h4>
              ...
              <div className="space-y-3">
                {userProfile.lectures.map((lectureItem) => (
                  <div key={lectureItem.id} className="bg-gray-50 rounded-lg p-4 relative group">
                    <h4 className="font-bold text-gray-900">{lectureItem.title}</h4>
                    <p className="text-sm text-gray-500 mt-1">
              ...
              <div className="space-y-3">
                {userProfile.publications.map((publicationItem) => (
                  <div key={publicationItem.id} className="bg-gray-50 rounded-lg p-4 relative group">
                    <h4 className="font-bold text-gray-900">{publicationItem.title}</h4>
                    <p className="text-sm text-gray-500 mt-1">
