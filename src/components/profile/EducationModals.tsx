        ...
        >
          ...
          <div className="flex items-center justify-between p-4 bg-white border-b border-gray-100 sticky top-0 z-10">
            ...
            <button
              ...
              disabled={!e.school}
              className={`font-bold text-sm ${!e.school ? 'text-gray-300' : 'text-gray-900'}`}
            >
              保存
            </button>
          </div>
          ...
          <div className="p-4 space-y-6">
            ...
            <div>
              ...
              >
                <span className={e.school ? 'text-gray-900' : 'text-gray-400'}>
                  {e.school || '例）東京大学'}
                </span>
            ...
            <div>
              ...
              <div
                ...
                className="w-full border border-gray-200 rounded-md h-[45px] px-4 flex justify-between items-center cursor-pointer"
              >
                <span className={e.degree ? 'text-gray-900' : 'text-gray-400'}>
                  {e.degree || '学位を選択'}
                </span>
            ...
            <div>
              ...
              <div
                ...
                className="w-full border border-gray-200 rounded-md h-[45px] px-4 flex justify-between items-center cursor-pointer"
              >
                <span className={e.major ? 'text-gray-900' : 'text-gray-400'}>
                  {e.major || '例）経営学'}
                </span>
                <ChevronRight className="w-5 h-5 text-gray-400" />
              </div>
            ...
            <div className="flex gap-4">
              <div className="flex-1">
                ...
                <div
                  ...
                  className="w-full border border-gray-200 rounded-md h-[45px] px-4 flex justify-between items-center cursor-pointer"
                >
                  <span className={e.startDate ? 'text-gray-900' : 'text-gray-400'}>
              ...
              <div className="flex-1">
                ...
                <div
                  ...
                  className={`w-full border border-gray-200 rounded-md h-[45px] px-4 flex justify-between items-center ${e.isCurrent ? 'bg-gray-50 cursor-not-allowed' : 'cursor-pointer'}`}
                >
                  <span className={e.endDate && !e.isCurrent ? 'text-gray-900' : 'text-gray-400'}>
            ...
            >
              <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${e.isCurrent ? 'border-gray-900 bg-gray-900' : 'border-gray-300'}`}>
              ...
              <div className="w-full h-full overflow-y-auto snap-y snap-mandatory no-scrollbar relative" id="edu-year-scroll">
                ...
                {Array.from({ length: 50 }, (_, i) => new Date().getFullYear() + 5 - i).map(year => (
                  <div
                    ...
                    className={`h-8 flex items-center justify-center snap-center cursor-pointer ${e.tempYear === year ? 'text-xl font-bold text-gray-900' : 'text-gray-400'}`}
                  >
                    {year}年
                  </div>
                ))}
