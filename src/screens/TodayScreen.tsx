    ...
    <div className="p-4">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-base font-bold text-ink">{user.displayName || 'ゲストユーザー'}</h2>
        </div>
        <button
          onClick={onOpenProfile}
          className="px-3 py-1.5 border border-line rounded text-xs font-medium text-ink-muted"
        >
          マイプロフィール
        </button>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4 snap-x no-scrollbar">
          {/* Card 1 */}
          <div className="min-w-[200px] bg-surface border border-line rounded-lg p-3.5 snap-start">
            <div className="flex items-center gap-2 mb-2">
              <User className="w-4 h-4 text-ink-muted" />
              <h4 className="font-bold text-ink text-xs">プロフィール写真</h4>
            </div>
            <p className="text-xs text-ink-muted mb-4 h-8 leading-relaxed">
          ...
          <div className="min-w-[200px] bg-surface border border-line rounded-lg p-3.5 snap-start">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-bold text-ink text-xs">自己紹介</h4>
            </div>
            <p className="text-xs text-ink-muted mb-4 h-8 leading-relaxed">
            ...
            <button
              ...
              className={`w-full font-bold py-2 rounded text-xs ${completedProfileSteps.includes(2) ? 'bg-primary-soft text-ink-muted' : 'bg-primary text-white'}`}
            >
          ...
          <div className="min-w-[200px] bg-surface border border-line rounded-lg p-3.5 snap-start">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-bold text-ink text-xs">経歴情報</h4>
            </div>
            <p className="text-xs text-ink-muted mb-4 h-8 leading-relaxed">
              代表的な経歴を入力してください
            </p>
            <button
              ...
              className={`w-full font-bold py-2 rounded text-xs ${completedProfileSteps.includes(3) ? 'bg-primary-soft text-ink-muted' : 'bg-primary text-white'}`}
            >
          ...
          <div className="min-w-[200px] bg-surface border border-line rounded-lg p-3.5 snap-start">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-bold text-ink text-xs">総経歴年数</h4>
            </div>
            <p className="text-xs text-ink-muted mb-4 h-8 leading-relaxed">
              総経歴年数を教えてください
            </p>
          ...
          <div className="min-w-[200px] bg-surface border border-line rounded-lg p-3.5 snap-start">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-bold text-ink text-xs">スキル</h4>
            </div>
            <p className="text-xs text-ink-muted mb-4 h-8 leading-relaxed">
              職務スキルを教えてください
            </p>
          ...
          <div className="min-w-[200px] bg-surface border border-line rounded-lg p-3.5 snap-start">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-bold text-ink text-xs">学歴</h4>
            </div>
            <p className="text-xs text-ink-muted mb-4 h-8 leading-relaxed">
              最終学歴を教えてください
            </p>
            <button
              ...
              className={`w-full font-bold py-2 rounded text-xs ${completedProfileSteps.includes(6) ? 'bg-primary-soft text-ink-muted' : 'bg-primary text-white'}`}
            >
